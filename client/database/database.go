...
func InitDB() {
	...
	go func(ctx context.Context) {
		// 从环境变量中获取数据库配置
		Username := os.Getenv("FM_DB_USERNAME")
		Password := os.Getenv("FM_DB_PASSWORD")
		Hostname := os.Getenv("FM_DB_HOSTNAME")
		Dbname := os.Getenv("FM_DB_DBNAME")
		// 连接数据库
		...
		var temp []interface{}
		temp = append(temp, &model.Data{}, &model.User{}, &model.MCU{}, &model.UserMCU{})
